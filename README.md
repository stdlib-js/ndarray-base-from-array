...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-base-from-array/tags). For example,

```javascript
array2ndarray = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-from-array@v0.1.0-umd/browser.js' )
```
